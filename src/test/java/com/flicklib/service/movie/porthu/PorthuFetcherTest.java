...
public class PorthuFetcherTest {
    ...
    public void setUp() throws Exception {
        ...
        loader.putAlias("http://port.hu/pls/ci/cinema.film_creator?i_text=a+kiraly+osszes+embere&i_film_creator=1&i_city_id=3372", "porthu/filmsearch-response2.html");
    ...
    public void testSearch() {
        try {
            ...
            Assert.assertNotNull("result not null", result);
            Assert.assertEquals("has enough results", 3, result.size());
            check(result.get(0), "A király összes embere", "83459", "All the King's Men", "színes, fekete-fehér magyarul beszélő német-amerikai filmdráma, 128 perc, 2006", 2006);
